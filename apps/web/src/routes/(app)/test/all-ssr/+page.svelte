...
<svelte:head>
	<title>Test - All Data SSR - Abdelilah Ouaadouch</title>
	<meta name="description" content="Test variant: All data (projects, blog, GitHub) with SSR mode." />
	<meta name="keywords" content="test, SSR, projects, blog, github, rendering" />
	<link rel="canonical" href={"https://personal-website.ar7al.workers.dev/test/all-ssr"} />

	<!-- Open Graph -->
	<meta property="og:type" content="website" />
	<meta property="og:url" content={"https://personal-website.ar7al.workers.dev/test/all-ssr"} />
	<meta property="og:title" content="Test - All Data SSR - Abdelilah Ouaadouch" />
	<meta property="og:description" content="Test variant: All data (projects, blog, GitHub) with SSR mode." />
	...
	<meta name="twitter:url" content={"https://personal-website.ar7al.workers.dev/test/all-ssr"} />
	<meta name="twitter:title" content="Test - All Data SSR - Abdelilah Ouaadouch" />
	<meta name="twitter:description" content="Test variant: All data (projects, blog, GitHub) with SSR mode." />
