...
<svelte:head>
	<title>Test - GitHub Prerender - Abdelilah Ouaadouch</title>
	<meta name="description" content="Test variant: GitHub contributions data with prerender mode." />
	<meta name="keywords" content="test, prerender, github, contributions, rendering" />
	<link rel="canonical" href={"https://personal-website.ar7al.workers.dev/test/github-prerender"} />

	<!-- Open Graph -->
	<meta property="og:type" content="website" />
	<meta property="og:url" content={"https://personal-website.ar7al.workers.dev/test/github-prerender"} />
	<meta property="og:title" content="Test - GitHub Prerender - Abdelilah Ouaadouch" />
	<meta property="og:description" content="Test variant: GitHub contributions data with prerender mode." />
	...
	<meta name="twitter:url" content={"https://personal-website.ar7al.workers.dev/test/github-prerender"} />
	<meta name="twitter:title" content="Test - GitHub Prerender - Abdelilah Ouaadouch" />
	<meta name="twitter:description" content="Test variant: GitHub contributions data with prerender mode." />
