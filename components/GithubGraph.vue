        ...
        <div class="relative flex gap-1 mt-5">
          ...
          >
            <div
              ...
              :key="dayIndex"
              :class="['h-4 w-4 my-1', getTileColor(day.contributions)]"
      ...
      <div class="flex items-center">
        ...
        <div class="flex">
          <div
            ...
            :key="level"
            :class="['h-4 w-4 mx-0.5', getColorClass(level)]"
          ></div>
        </div>
...
const getTileColor = (contributions: number): string => {
  if (contributions === -1) return "bg-gray-800";
